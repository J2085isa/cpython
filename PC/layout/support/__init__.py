...
jobs:
  ...
  samples-test-job:
    ...
    name: "Samples
{
  "tipo_operacion": "SALARIO",
  "datos_operacion": {
    "empleado": {
      "rfc": "XXXXXXXXXXXXXX",
      "curp": "XXXXXXXXXXXXXXXXXX",
      "nombre": "Nombre completo del empleado",
      "num_contrato": "CON-001-2026"
    },
    "periodo": {
      "inicio": "2026-01-01",
      "fin": "2026-01-15"
    ...
    "deducciones": {
      "isr": 320.00,
      "imss": 450.00,
      "total_deducciones": 770.00
    },
    "monto_neto": 7730.00,
    "metodo_pago": "SPEI",
    "clabe_empleado": "098765432109876543"
  }
}
{
  "id_operacion": "QNT-20260114-0001",
  "tipo_operacion": "DONACION" | "SALARIO",
  "monto_total": 1500.00 | 8500.00,
  "asignaciones": {
    "monto_principal": 1425.00 | 7730.00,
    "monto_gestion": 75.00 | 0.00,
    "cuenta_gestion": {
      "banco": "Banco XYZ",
  ...
  "energia_generada_ecr": 1,
  "sincronizacion_cuantica": {
    "estado": "completada",
    "nodos_actualizados": ["SAT", "Banco XYZ", "Contabilidad Soft", "Portal de Transparencia"],
    "fecha_sincronizacion": "2026-01-14T14:15:00-06:00"
  },
  "comprobantes": {
    "cfdi_principal": "https://api.quantica-pay.mx/comprobantes/QNT-20260114-0001-principal.pdf",
    "cfdi_gestion": "https://api.quantica-pay.mx/comprobantes/QNT-20260114-0001-gestion.pdf" | null,
    "registro_sat": "https://portal.sat.gob.mx/consultas/{codigo_registro}",
    "registro_imss": "https://www.imss.gob.mx/constancias/{codigo_constancia}" | null
  },
  "fecha_registro": "2026-01-14T14:15:00-06:00"
}
{
  "periodo": "2026-01",
  "tipo_reporte": "TODOS",
  "resumen_operaciones": {
    "total_donaciones": 4500.00,
    "total_gestion": 225.00,
    "total_salarios": 30920.00,
    "total_operaciones": 35420.00
  },
  "estadisticas_cuanticas": {
    "energia_total_generada_ecr": 32,
    "sincronizaciones_completadas": 32,
    "nodos_actualizados_totales": 160,
    "eficiencia_sistema": "99.8%"
  },
  "resumen_fiscal": {
    "isr_retencion": 1280.00,
    "imss_cotizaciones": 1800.00,
    "url_reporte_sat": "https://portal.sat.gob.mx/reportes/{codigo_reporte}",
    "certificado_cumplimiento": "https://api.quantica-pay.mx/certificados/QNT-REP-202601-cumplimiento.pdf"
  },
  "operaciones": [/* Lista de operaciones con detalles de cada nodo */],
  "fecha_generacion": "2026-01-14T14:30:00-06:00"
}
